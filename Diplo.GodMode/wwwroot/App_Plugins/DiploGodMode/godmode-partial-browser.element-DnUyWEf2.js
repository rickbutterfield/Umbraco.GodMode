...
import { s as E, a as I } from "./index-DRMAqfy-.js";
...
}, $ = (t, e, a) => e.has(t) || _("Cannot " + a), A = (t, e, a) => e.has(t) ? _("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), o = (t, e, a) => ($(t, e, "access private method"), a), l, b, v, p, g, y, c;
let i = class extends D(C) {
  constructor() {
    super(), A(this, l), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
...
//# sourceMappingURL=godmode-partial-browser.element-DnUyWEf2.js.map
