...
import { LitElement as k, ifDefined as N, html as A, css as P, property as O, customElement as x, state as p } from "@umbraco-cms/backoffice/external/lit";
import { tryExecuteAndNotify as T } from "@umbraco-cms/backoffice/resources";
import { UmbUniqueTreeStore as ee } from "@umbraco-cms/backoffice/tree";
...
}, re = "Umb.Repository.GodMode.Tree", ae = "Umb.Store.GodMode.Tree", oe = "Umb.Tree.GodMode";
var se = Object.defineProperty, ne = Object.getOwnPropertyDescriptor, $ = (t, e, r, a) => {
  for (var o = a > 1 ? void 0 : a ? ne(e, r) : e, i = t.length - 1, c; i >= 0; i--)
    (c = t[i]) && (o = (a ? c(e, r, o) : c(o)) || o);
  return a && o && se(e, r, o), o;
};
let E = class extends I(k) {
  constructor() {
    super();
  }
  render() {
...
const y = (t) => typeof t == "string", U = (t) => y(t) && t !== "", _ = (t) => t instanceof Blob, B = (t) => t instanceof FormData, de = (t) => {
  try {
    return btoa(t);
  } catch {
  ...
  const r = encodeURI, a = e.url.replace("{api-version}", t.VERSION).replace(/{(.*?)}/g, (i, c) => {
    var d;
    return (d = e.path) != null && d.hasOwnProperty(c) ? r(String(e.path[c])) : i;
  }), o = t.BASE + a;
  return e.query ? o + ue(e.query) : o;
}, he = (t) => {
  if (t.formData) {
    const e = new FormData(), r = (a, o) => {
      y(o) || _(o) ? e.append(a, o) : e.append(a, JSON.stringify(o));
    };
    return Object.entries(t.formData).filter(([, a]) => a != null).forEach(([a, o]) => {
      Array.isArray(o) ? o.forEach((i) => r(a, i)) : r(a, o);
    }), e;
  }
}, M = async (t, e) => typeof e == "function" ? e(t) : e, le = async (t, e) => {
  ...
  return e.body !== void 0 && (e.mediaType ? c["Content-Type"] = e.mediaType : _(e.body) ? c["Content-Type"] = e.body.type || "application/octet-stream" : y(e.body) ? c["Content-Type"] = "text/plain" : B(e.body) || (c["Content-Type"] = "application/json")), new Headers(c);
}, pe = (t) => {
  var e, r;
  if (t.body !== void 0)
    return (e = t.mediaType) != null && e.includes("application/json") || (r = t.mediaType) != null && r.includes("+json") ? JSON.stringify(t.body) : y(t.body) || _(t.body) || B(t.body) ? t.body : JSON.stringify(t.body);
}, ge = async (t, e, r, a, o, i, c) => {
  ...
  for (const g of t.interceptors.request._fns)
    G = await g(G);
  return c(() => d.abort()), await fetch(r, G);
}, Te = (t, e) => {
  if (e) {
...
}, n = (t, e) => new ce(async (r, a, o) => {
  try {
    const i = me(t, e), c = he(e), d = pe(e), G = await le(t, e);
    if (!o.isCancelled) {
      let g = await ge(t, e, i, d, c, G, o);
      for (const Q of t.interceptors.response._fns)
        g = await Q(g);
      const S = await be(g), X = Te(g, e.responseHeader);
      let w = S;
      e.responseTransformer && g.ok && (w = await e.responseTransformer(S));
      const q = {
        url: i,
        ok: g.ok,
        status: g.status,
...
var f = /* @__PURE__ */ ((t) => (t.ASCENDING = "Ascending", t.DESCENDING = "Descending", t))(f || {});
const fe = (t, e, r) => e && r ? t.sort((a, o) => {
  const i = a[e], c = o[e];
  return i < c ? r === f.ASCENDING ? -1 : 1 : i > c ? r === f.ASCENDING ? 1 : -1 : 0;
}) : t;
var ye = Object.defineProperty, ve = Object.getOwnPropertyDescriptor, j = (t) => {
  throw TypeError(t);
}, h = (t, e, r, a) => {
  for (var o = a > 1 ? void 0 : a ? ve(e, r) : e, i = t.length - 1, c; i >= 0; i--)
    (c = t[i]) && (o = (a ? c(e, r, o) : c(o)) || o);
  return a && o && ye(e, r, o), o;
}, Me = (t, e, r) => e.has(t) || j("Cannot " + r), Ae = (t, e, r) => e.has(t) ? j("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), l = (t, e, r) => (Me(t, e, "access private method"), r), m, F, H, C, L, W, z, J, v;
let u = class extends I(k) {
  constructor() {
    super(), Ae(this, m), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
  ...
  async connectedCallback() {
    super.connectedCallback(), l(this, m, H).call(this);
  }
  render() {
    return A`
            <umb-body-layout>
                <godmode-header name=${N(this.name)} slot="header"></godmode-header>
                <uui-box>
                    <div class="grid">
                        <div>
                ...
                ${this._tableItems.length !== 0 ? A`
                        <uui-box style="--uui-box-default-padding: 0;">
                            <umb-table .config=${this._tableConfig} .columns=${this._tableColumns} .items=${this._tableItems} @ordered=${l(this, m, F)} />
                        </uui-box>
                    ` : A``}
            </umb-body-layout>
        `;
...
F = function(t) {
  ...
  this.filteredData = fe(structuredClone(this.data), r, a ? f.DESCENDING : f.ASCENDING), this._tableItems = l(this, m, C).call(this, this.filteredData);
};
H = async function() {
  if (this.type) {
    let t = {};
    if (this.type === "surface" && (this.name = "Surface Controller Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetSurfaceControllers())), this.type === "api" && (this.name = "API Controller Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetApiControllers())), this.type === "render" && (this.name = "RenderMvc Controller Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetRenderMvcControllers())), this.type === "models" && (this.name = "Published Content Model Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetPublishedContentModels())), this.type === "composers" && (this.name = "Composer Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetComposers())), this.type === "converters" && (this.name = "Property Value Converter Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetRenderMvcControllers())), this.type === "components" && (this.name = "View Component Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetViewComponents())), this.type === "taghelpers" && (this.name = "Tag Helpers Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetTagHelpers())), this.type === "finders" && (this.name = "Content Finders Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetContentFinders())), this.type === "urlproviders" && (this.name = "URL Providers Browser", t = await T(this, b.getUmbracoManagementApiV1GodModeGetUrlProviders())), t && t.data) {
      this.data = t.data, this.filteredData = structuredClone(this.data), this._tableItems = l(this, m, C).call(this, this.filteredData);
...
L = function(t) {
  ...
  this.searchName = e, l(this, m, v).call(this);
};
W = function(t) {
  const e = t.target.value;
  this.selectedNamespace = e, l(this, m, v).call(this);
};
z = function(t) {
  const e = t.target.value;
  this.selectedInherits = e, l(this, m, v).call(this);
};
J = function(t) {
  const e = t.target.value;
  this.selectedUmbraco = e, l(this, m, v).call(this);
};
v = function() {
  var t, e, r, a;
  this.filteredData = structuredClone(this.data), this.searchName !== "" && (this.filteredData = (t = this.filteredData) == null ? void 0 : t.filter((o) => o.name.toLowerCase().includes(this.searchName))), this.selectedNamespace !== "" && (this.filteredData = (e = this.filteredData) == null ? void 0 : e.filter((o) => o.namespace === this.selectedNamespace)), this.selectedInherits !== "" && (this.filteredData = (r = this.filteredData) == null ? void 0 : r.filter((o) => o.baseType === this.selectedInherits)), this.selectedUmbraco !== "" && (this.filteredData = (a = this.filteredData) == null ? void 0 : a.filter((o) => o.isUmbraco === (this.selectedUmbraco === "Yes"))), this.filteredData ? this._tableItems = l(this, m, C).call(this, this.filteredData) : this._tableItems = [];
};
u.styles = [
  P`
            .grid {
...
const $e = u, Ee = {
  ...
  element: () => import("./godmode-root-workspace.element-DpcZcJ_P.js"),
  meta: {
  ...
  api: () => import("./godmode-workspace.context-Pn-7eSWd.js"),
  meta: {
    entityType: "godmode"
  }
}, Ue = {
  ...
  element: () => import("./godmode-folder-workspace.element-CgsOOYep.js"),
  meta: {
...
const Y = new te("GodModeTreeStore"), Ve = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  GOD_MODE_TREE_STORE_CONTEXT: Y,
  GodModeTreeStore: D,
  default: D
}, Symbol.toStringTag, { value: "Module" })), De = [
  {
    ...
    api: () => import("./godmode-tree.repository-popuh3uJ.js")
  },
  {
    type: "treeStore",
    alias: ae,
    name: "God Mode Tree Store",
    api: () => Promise.resolve().then(() => Ve)
  },
  {
    type: "tree",
    kind: "default",
...
//# sourceMappingURL=index-DRMAqfy-.js.map
