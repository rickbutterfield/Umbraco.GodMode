import { repeat as m, html as c, css as w, state as d, customElement as b } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as y } from "@umbraco-cms/backoffice/lit-element";
import { G as g } from "./index-D2VaFLfx.js";
...
}, _ = (e, t, r) => t.has(e) || p("Cannot " + r), T = (e, t, r) => t.has(e) ? p("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), x = (e, t, r) => (_(e, t, "access private method"), r), u, h;
    ...
    return c`
      ...
      (e) => c`
                                    <uui-table-row>
                                        <uui-table-cell>
                                            <strong>
                                            <uui-button href="/umbraco/section/settings/workspace/godmode/edit/${e.url}">${e.name}</uui-button>
                                            </strong>
                                        </uui-table-cell>
                                        <uui-table-cell>
                                            ${e.description}
...
h = async function() {
  const { data: e } = await f(this, g.getConfig());
...
//# sourceMappingURL=godmode-root-workspace.element-ZL380WUF.js.map
