...
import { LitElement as N, repeat as f, html as r, css as O, state as c, customElement as D } from "@umbraco-cms/backoffice/external/lit";
import { tryExecute as v } from "@umbraco-cms/backoffice/resources";
import { G as b } from "./index-Car7Rj8s.js";
import { UMB_NOTIFICATION_CONTEXT as S } from "@umbraco-cms/backoffice/notification";
var A = Object.defineProperty, B = Object.getOwnPropertyDescriptor, C = (e) => {
  throw TypeError(e);
}, h = (e, t, i, l) => {
  for (var s = l > 1 ? void 0 : l ? B(t, i) : t, p = e.length - 1, a; p >= 0; p--)
    (a = e[p]) && (s = (l ? a(t, i, s) : a(s)) || s);
  return l && s && A(t, i, s), s;
}, T = (e, t, i) => t.has(e) || C("Cannot " + i), $ = (e, t, i) => (T(e, t, "read from private field"), t.get(e)), w = (e, t, i) => t.has(e) ? C("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), F = (e, t, i, l) => (T(e, t, "write to private field"), t.set(e, i), i), n = (e, t, i) => (T(e, t, "access private method"), i), g, o, y, _, G, L, m, x, k;
let d = class extends E(N) {
  constructor() {
    super(), w(this, o), w(this, g), this.tags = [], this.filteredTags = [], this.orphanedTags = [], this.searchTagName = "", this.searchTagGroup = "", this.searchTagContent = "", this.isLoading = !0, this.consumeContext(S, (e) => {
      F(this, g, e);
    });
  }
                            ...
                            <div slot="headline" class="tag-header">
                                <div class="tag-info">
                                    <h3>
                                        ...
                                        <span class="node-count">${((i = e.tag) == null ? void 0 : i.nodeCount) || 0}</span>
                                        <span class="label">${((l = e.tag) == null ? void 0 : l.group) || ""}</span>
                                        ${(s = e.tag) != null && s.culture ? r`<span class="label">${e.tag.culture}</span>` : ""}
                                    </h3>
                                </div>
                                <div>
                                    <uui-button 
                                        ...
                                        @click=${() => {
          var a, u;
          return n(this, o, x).call(this, ((a = e.tag) == null ? void 0 : a.id) || 0, ((u = e.tag) == null ? void 0 : u.text) || "");
        }}>
                                        Delete
                                    </uui-button>
                                </div>
      ...
      (e) => r`
                                    <li>
                                        ...
                                        <uui-button 
                                            ...
                                            @click=${() => n(this, o, x).call(this, (e == null ? void 0 : e.id) || 0, (e == null ? void 0 : e.text) || "")}>
...
y = async function() {
  this.isLoading = !0;
  const { data: e } = await v(this, b.getUmbracoManagementApiV1GodModeGetTagMapping()), { data: t } = await v(this, b.getUmbracoManagementApiV1GodModeGetOrphanedTags());
...
m = function() {
  this.filteredTags = this.tags.filter((e) => {
    var t, i;
    return !(this.searchTagName && ((t = e.tag) != null && t.text) && !e.tag.text.toLowerCase().includes(this.searchTagName) || this.searchTagGroup && ((i = e.tag) != null && i.group) && !e.tag.group.toLowerCase().includes(this.searchTagGroup) || this.searchTagContent && e.content && !e.content.some(
      (s) => (s == null ? void 0 : s.name) && s.name.toLowerCase().includes(this.searchTagContent)
    ));
  });
};
x = async function(e, t) {
  ...
  if (!window.confirm(`Are you sure you want to permanently delete the tag '${t}'?`))
    return;
  const { data: i } = await v(this, b.postUmbracoManagementApiV1GodModeDeleteTag({ query: { id: e } }));
  i ? ((l = $(this, g)) == null || l.peek("positive", { data: { message: `Successfully deleted the tag '${t}'` } }), n(this, o, y).call(this)) : (s = $(this, g)) == null || s.peek("danger", { data: { message: `Error deleting the tag '${t}'` } });
};
k = function(e) {
...
//# sourceMappingURL=godmode-tag-browser.element-C7IRXmfU.js.map
