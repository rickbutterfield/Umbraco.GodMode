...
import { a as p } from "./index-DRMAqfy-.js";
import { UMB_NOTIFICATION_CONTEXT as P } from "@umbraco-cms/backoffice/notification";
import { UmbLanguageCollectionRepository as A } from "@umbraco-cms/backoffice/language";
var $ = Object.defineProperty, x = Object.getOwnPropertyDescriptor, U = (e) => {
  throw TypeError(e);
}, u = (e, t, i, a) => {
...
let s = class extends T {
  constructor() {
    super(), g(this, m), g(this, r), g(this, w, new A(this)), this.languages = [], this.cultures = [], this._selectedCulture = "", this.warmingUp = !1, this.warmUpCurrentUrl = "", this.warmUpCurrent = 1, this.warmUpCount = 0, this.consumeContext(P, (e) => {
      E(this, r, e);
...
//# sourceMappingURL=godmode-utility-browser.element-Dd2xasGV.js.map
