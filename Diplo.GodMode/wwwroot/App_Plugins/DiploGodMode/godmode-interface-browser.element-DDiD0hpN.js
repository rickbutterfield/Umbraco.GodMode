...
import { s as x, D as b, G as h } from "./index-Car7Rj8s.js";
...
var $ = Object.defineProperty, C = Object.getOwnPropertyDescriptor, y = (t) => {
  ...
  return c && l && $(e, s, l), l;
}, G = (t, e, s) => e.has(t) || y("Cannot " + s), M = (t, e, s) => e.has(t) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), u = (t, e, s) => (G(t, e, "access private method"), s), o, g, v, I, _, d;
...
//# sourceMappingURL=godmode-interface-browser.element-DDiD0hpN.js.map
