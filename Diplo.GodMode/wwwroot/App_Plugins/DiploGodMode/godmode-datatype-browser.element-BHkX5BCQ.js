...
import { LitElement as U, html as n, css as C, state as l, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
import { tryExecute as f } from "@umbraco-cms/backoffice/resources";
import { s as S, G as y } from "./index-D76lIRat.js";
import { DirectionModel as b } from "@umbraco-cms/backoffice/external/backend-api";
var O = Object.defineProperty, A = Object.getOwnPropertyDescriptor, g = (e) => {
  throw TypeError(e);
}, r = (e, t, a, i) => {
  for (var u = i > 1 ? void 0 : i ? A(t, a) : t, c = e.length - 1, m; c >= 0; c--)
    (m = e[c]) && (u = (i ? m(t, a, u) : m(u)) || u);
  return i && u && O(t, a, u), u;
}, I = (e, t, a) => t.has(e) || g("Cannot " + a), N = (e, t, a) => t.has(e) ? g("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), d = (e, t, a) => (I(e, t, "access private method"), a), o, v, _, h, D, T, w, x, p;
let s = class extends E(U) {
  constructor() {
    super(), N(this, o), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
...
//# sourceMappingURL=godmode-datatype-browser.element-BHkX5BCQ.js.map
