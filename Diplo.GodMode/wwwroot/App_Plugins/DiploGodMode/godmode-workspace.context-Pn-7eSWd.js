...
import { b as i } from "./index-DRMAqfy-.js";
  ...
  constructor(t) {
    super(t), this.workspaceAlias = "Umb.Workspace.GodMode", this.routes = new p(this), this.routes.setRoutes([
      ...
      },
      {
        ...
        component: () => import("./godmode-template-browser.element-DmgQtr-2.js")
      },
      {
        path: "edit/partialBrowser",
        component: () => import("./godmode-partial-browser.element-DnUyWEf2.js")
      },
      {
      ...
      },
      {
        ...
        component: () => import("./godmode-services-browser.element-heJ8u58t.js")
      },
      {
        path: "edit/diagnosticBrowser",
        component: () => import("./godmode-diagnostic-browser.element-_zjUhb68.js")
      },
      {
        path: "edit/utilityBrowser",
        component: () => import("./godmode-utility-browser.element-Dd2xasGV.js")
      },
      {
      ...
      },
      {
        ...
        component: () => import("./godmode-interface-browser.element-CZbT6Mgu.js")
      }
    ]);
  }
  getEntityType() {
...
//# sourceMappingURL=godmode-workspace.context-Pn-7eSWd.js.map
