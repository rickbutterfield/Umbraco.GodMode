...
import { s as S, a as O } from "./index-DRMAqfy-.js";
...
var $ = Object.defineProperty, E = Object.getOwnPropertyDescriptor, v = (t) => {
  ...
  return a && i && $(e, s, i), i;
}, P = (t, e, s) => e.has(t) || v("Cannot " + s), I = (t, e, s) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), o = (t, e, s) => (P(t, e, "access private method"), s), r, b, _, d, g, y, D, h;
...
b = function(t) {
  ...
  this.filteredData = S(structuredClone(this.templates), s, a ? f.DESCENDING : f.ASCENDING), this._tableItems = o(this, r, d).call(this, this.filteredData);
};
_ = async function() {
  const { data: t } = await N(this, O.getUmbracoManagementApiV1GodModeGetTemplates());
  if (t) {
    this.templates = t, this.filteredData = structuredClone(this.templates), this._tableItems = o(this, r, d).call(this, this.filteredData);
...
g = function(t) {
  ...
  this.searchName = e, o(this, r, h).call(this);
};
y = function(t) {
  const e = t.target.value;
  this.selectedMaster = e, o(this, r, h).call(this);
};
D = function(t) {
  const e = t.target.value;
  this.selectedMaster = e, o(this, r, h).call(this);
...
h = function() {
  ...
  })), this.filteredData ? this._tableItems = o(this, r, d).call(this, this.filteredData) : this._tableItems = [];
};
l.styles = [
  w`
            .grid {
...
//# sourceMappingURL=godmode-template-browser.element-DmgQtr-2.js.map
