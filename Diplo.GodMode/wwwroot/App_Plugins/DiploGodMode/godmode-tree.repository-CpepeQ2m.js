import { UmbTreeServerDataSourceBase as a, UmbTreeRepositoryBase as o } from "@umbraco-cms/backoffice/tree";
import { G as l } from "./index-DoLw8Ovk.js";
const n = "godmode", i = "godmode-root", t = "godmode-folder";
class c extends a {
  constructor(r) {
    super(r, {
      getRootItems: s,
...
}), d = async (e) => e.parent.unique === null ? s() : {
  data: {
    total: 0,
    items: [
      {
...
export {
  u as GodModeTreeRepository,
  u as api
};
//# sourceMappingURL=godmode-tree.repository-CpepeQ2m.js.map
