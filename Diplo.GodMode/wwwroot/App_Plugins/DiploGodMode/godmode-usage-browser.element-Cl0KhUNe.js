...
import { LitElement as C, html as a, css as $, state as l, customElement as x } from "@umbraco-cms/backoffice/external/lit";
import { tryExecute as A } from "@umbraco-cms/backoffice/resources";
import { s as S, G as L } from "./index-D2VaFLfx.js";
...
var E = Object.defineProperty, I = Object.getOwnPropertyDescriptor, m = (t) => {
  ...
  for (var u = c > 1 ? void 0 : c ? I(e, i) : e, p = t.length - 1, f; p >= 0; p--)
    (f = t[p]) && (u = (c ? f(e, i, u) : f(u)) || u);
  return c && u && E(e, i, u), u;
}, T = (t, e, i) => e.has(t) || m("Cannot " + i), O = (t, e, i) => e.has(t) ? m("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), r = (t, e, i) => (T(t, e, "access private method"), i), o, b, y, v, _, D, h, d;
let s = class extends w(C) {
  constructor() {
    super(), O(this, o), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
...
b = function(t) {
  ...
  this.filteredData = S(structuredClone(this.filteredData), i, c ? g.DESCENDING : g.ASCENDING), this._tableItems = r(this, o, d).call(this, this.filteredData);
};
y = async function() {
  this.isLoading = !0;
  const { data: t } = await A(this, L.getContentUsageData());
  if (t) {
    this.data = t;
    const e = /* @__PURE__ */ new Set();
    t.forEach((i) => {
      i.type && e.add(i.type);
    }), this.typeOptions = Array.from(e), this.filteredData = structuredClone(this.data), this._tableItems = r(this, o, d).call(this, this.filteredData);
  }
  this.isLoading = !1;
};
v = function(t) {
  this.searchAlias = t.target.value.toLowerCase(), r(this, o, h).call(this);
};
_ = function(t) {
  this.searchDescription = t.target.value.toLowerCase(), r(this, o, h).call(this);
};
D = function(t) {
  this.selectedType = t.target.value, r(this, o, h).call(this);
};
h = function() {
  this.filteredData = this.data.filter((t) => !(this.searchAlias && t.alias && !t.alias.toLowerCase().includes(this.searchAlias) || this.searchDescription && t.description && !t.description.toLowerCase().includes(this.searchDescription) || this.selectedType && t.type && t.type !== this.selectedType)), this._tableItems = r(this, o, d).call(this, this.filteredData);
};
d = function(t) {
  return t.map((e) => {
    var i;
...
//# sourceMappingURL=godmode-usage-browser.element-Cl0KhUNe.js.map
