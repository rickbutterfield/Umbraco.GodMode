...
import { G as $ } from "./index-olPh7UBx.js";
import { tryExecute as x } from "@umbraco-cms/backoffice/resources";
var V = Object.defineProperty, K = Object.getOwnPropertyDescriptor, v = (t) => {
  throw TypeError(t);
}, l = (t, e, i, s) => {
  for (var o = s > 1 ? void 0 : s ? K(e, i) : e, h = t.length - 1, d; h >= 0; h--)
    (d = t[h]) && (o = (s ? d(e, i, o) : d(o)) || o);
  return s && o && V(e, i, o), o;
}, E = (t, e, i) => e.has(t) || v("Cannot " + i), L = (t, e, i) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), u = (t, e, i) => (E(t, e, "access private method"), i), a, y, g, b, m, p, G;
let r = class extends C {
  constructor() {
    super(), L(this, a), this.diagnostics = [], this.currentGroup = void 0, this.filteredSections = [], this.currentGroupId = "", this.searchKey = "", this.searchValue = "", this.configurationGroups = [], u(this, a, y).call(this);
  }
  render() {
    return n`
            <umb-body-layout>
...
y = async function() {
  var e;
  const { data: t } = await x(this, $.getEnvironmentDiagnostics());
  if (t) {
    this.diagnostics = t;
...
//# sourceMappingURL=godmode-diagnostic-browser.element-dDLfuhHZ.js.map
