...
import { s as H, G as k } from "./index-fy-rxTHq.js";
...
_ = async function() {
  this.isLoading = !0;
  const { data: e } = await N(this, k.getContentTypeMap());
  if (e) {
...
//# sourceMappingURL=godmode-doctype-browser.element-DH3txxSM.js.map
