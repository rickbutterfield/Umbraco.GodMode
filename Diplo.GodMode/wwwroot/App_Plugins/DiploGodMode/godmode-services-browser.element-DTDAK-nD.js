...
import { LitElement as C, html as p, css as x, state as c, customElement as L } from "@umbraco-cms/backoffice/external/lit";
import { tryExecute as E } from "@umbraco-cms/backoffice/resources";
import { s as A, G } from "./index-fy-rxTHq.js";
...
var M = Object.defineProperty, O = Object.getOwnPropertyDescriptor, b = (t) => {
  ...
  for (var i = o > 1 ? void 0 : o ? O(e, m) : e, h = t.length - 1, n; h >= 0; h--)
    (n = t[h]) && (i = (o ? n(e, m, i) : n(i)) || i);
  return o && i && M(e, m, i), i;
}, P = (t, e, m) => e.has(t) || b("Cannot " + m), B = (t, e, m) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, m), l = (t, e, m) => (P(t, e, "access private method"), m), a, g, N, d, y, _, D, I, w, S, u;
...
g = function(t) {
  ...
  this.filteredData = A(structuredClone(this.data), m, o ? v.DESCENDING : v.ASCENDING), this._tableItems = l(this, a, d).call(this, this.filteredData);
};
N = async function() {
  const { data: t } = await E(this, G.getRegisteredServices());
  if (t) {
    this.data = t, this.filteredData = structuredClone(this.data), this._tableItems = l(this, a, d).call(this, this.filteredData);
...
u = function() {
  var t, e, m, o, i, h;
  this.filteredData = structuredClone(this.data), this.searchName !== "" && (this.filteredData = (t = this.filteredData) == null ? void 0 : t.filter((n) => n.name.toLowerCase().includes(this.searchName))), this.searchImplemented !== "" && (this.filteredData = (e = this.filteredData) == null ? void 0 : e.filter((n) => {
    var f;
    return (f = n.implementName) == null ? void 0 : f.toLowerCase().includes(this.searchImplemented);
  })), this.selectedLifetime !== "" && (this.filteredData = (m = this.filteredData) == null ? void 0 : m.filter((n) => n.lifetime === this.selectedLifetime)), this.selectedNamespace !== "" && (this.filteredData = (o = this.filteredData) == null ? void 0 : o.filter((n) => n.namespace === this.selectedNamespace)), this.selectedImplementedNamespace !== "" && (this.filteredData = (i = this.filteredData) == null ? void 0 : i.filter((n) => n.implementNamespace === this.selectedImplementedNamespace)), this.filteredData = (h = this.filteredData) == null ? void 0 : h.filter((n) => n.isPublic === this.visibility), this.filteredData ? this._tableItems = l(this, a, d).call(this, this.filteredData) : this._tableItems = [];
};
s.styles = [
  x`
            .grid {
...
//# sourceMappingURL=godmode-services-browser.element-DTDAK-nD.js.map
