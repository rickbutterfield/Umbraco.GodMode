...
import { s as x, G as h } from "./index-D2VaFLfx.js";
...
var $ = Object.defineProperty, C = Object.getOwnPropertyDescriptor, y = (t) => {
  ...
  return c && l && $(e, s, l), l;
}, E = (t, e, s) => e.has(t) || y("Cannot " + s), D = (t, e, s) => e.has(t) ? y("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), u = (t, e, s) => (E(t, e, "access private method"), s), o, v, g, I, _, d;
let i = class extends w {
  constructor() {
    ...
    ], this._tableItems = [], this.assemblies = [], this.assemblyOptions = [], this.currentAssembly = void 0, this.currentAssemblyOption = "", this.interfaces = [], this.interfaceOptions = [], this.currentInterface = void 0, this.currentInterfaceOption = "", this.types = [], u(this, o, g).call(this);
  }
  render() {
    var t;
    return r`
            ...
            ${this.types.length !== 0 ? r`
                <uui-box style="--uui-box-default-padding: 0;">
                  ${this._tableItems.length !== 0 ? r`
                        <uui-box style="--uui-box-default-padding: 0;">
                            <umb-table .config=${this._tableConfig} .columns=${this._tableColumns} .items=${this._tableItems} @ordered=${u(this, o, v)} />
                        </uui-box>
                    ` : r``}
                </uui-box>
              ` : r``}
...
g = async function() {
  const { data: t } = await f(this, h.getAssemblies());
...
I = async function(t) {
  if (this.currentAssemblyOption = t.target.value, this.currentAssemblyOption !== "") {
    ...
    const { data: e } = await f(this, h.getInterfacesFrom({ query: { assembly: this.currentAssemblyOption } }));
...
_ = async function(t) {
  if (this.currentInterfaceOption = t.target.value, this.currentInterfaceOption !== "") {
    if (this.currentInterface = this.interfaces.find((e) => e.name === this.currentInterfaceOption), this.currentInterface) {
      const { data: e } = await f(this, h.getTypesAssignableFrom({ query: { baseType: this.currentInterface.loadableName } }));
...
//# sourceMappingURL=godmode-interface-browser.element-D8VVtV_E.js.map
