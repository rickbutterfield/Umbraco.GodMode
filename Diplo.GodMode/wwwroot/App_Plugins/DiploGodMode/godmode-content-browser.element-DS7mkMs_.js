...
import { G as m, s as G } from "./index-D76lIRat.js";
...
var M = Object.defineProperty, E = Object.getOwnPropertyDescriptor, b = (t) => {
  ...
  for (var c = h > 1 ? void 0 : h ? E(e, l) : e, d = t.length - 1, g; d >= 0; d--)
    (g = t[d]) && (c = (h ? g(e, l, c) : g(c)) || c);
  return h && c && M(e, l, c), c;
}, T = (t, e, l) => e.has(t) || b("Cannot " + l), U = (t, e, l) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, l), i = (t, e, l) => (T(t, e, "access private method"), l), a, y, _, u, v, P, A, I, $, C, L, w, S;
let s = class extends D(N) {
  constructor() {
    super(), U(this, a), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
...
_ = function(t) {
  ...
  this.data = G(structuredClone(this.data), l, h ? f.DESCENDING : f.ASCENDING), this._tableItems = i(this, a, v).call(this, this.data);
};
u = async function() {
  this.isLoading = !0;
  const t = {
...
//# sourceMappingURL=godmode-content-browser.element-DS7mkMs_.js.map
