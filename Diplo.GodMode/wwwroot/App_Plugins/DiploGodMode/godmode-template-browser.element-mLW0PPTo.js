...
import { LitElement as w, html as p, css as M, state as u, customElement as x } from "@umbraco-cms/backoffice/external/lit";
import { tryExecute as S } from "@umbraco-cms/backoffice/resources";
import { s as N, G as O } from "./index-fy-rxTHq.js";
...
var $ = Object.defineProperty, E = Object.getOwnPropertyDescriptor, v = (t) => {
  ...
  for (var i = a > 1 ? void 0 : a ? E(e, s) : e, m = t.length - 1, c; m >= 0; m--)
    (c = t[m]) && (i = (a ? c(e, s, i) : c(i)) || i);
  return a && i && $(e, s, i), i;
}, P = (t, e, s) => e.has(t) || v("Cannot " + s), I = (t, e, s) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), o = (t, e, s) => (P(t, e, "access private method"), s), r, _, b, h, g, y, D, d;
let l = class extends C(w) {
  ...
  async connectedCallback() {
    super.connectedCallback(), o(this, r, b).call(this);
  }
  render() {
    return p`
            <umb-body-layout>
                ...
                ${this._tableItems.length !== 0 ? p`
                    <uui-box style="--uui-box-default-padding: 0;">
                        <umb-table .config=${this._tableConfig} .columns=${this._tableColumns} .items=${this._tableItems} @ordered=${o(this, r, _)} />
                    </uui-box>
                ` : p``}
            </umb-body-layout>
        `;
...
b = async function() {
  const { data: t } = await S(this, O.getTemplates());
  if (t) {
...
d = function() {
  ...
  this.filteredData = structuredClone(this.templates), this.searchName !== "" && (this.filteredData = (t = this.filteredData) == null ? void 0 : t.filter((a) => a.name.toLowerCase().includes(this.searchName))), this.selectedMaster !== "" && (this.filteredData = (e = this.filteredData) == null ? void 0 : e.filter((a) => {
    ...
    var i;
    return (i = a.partials) == null ? void 0 : i.some((m) => m.name === this.selectedPartial);
...
//# sourceMappingURL=godmode-template-browser.element-mLW0PPTo.js.map
