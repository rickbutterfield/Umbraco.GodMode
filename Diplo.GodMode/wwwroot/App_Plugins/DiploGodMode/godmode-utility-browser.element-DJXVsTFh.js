...
import { html as C, css as _, state as l, customElement as M } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as T } from "@umbraco-cms/backoffice/lit-element";
import { G as p } from "./index-D76lIRat.js";
...
var x = Object.defineProperty, A = Object.getOwnPropertyDescriptor, U = (e) => {
  throw TypeError(e);
}, u = (e, t, a, i) => {
  for (var n = i > 1 ? void 0 : i ? A(t, a) : t, d = e.length - 1, h; d >= 0; d--)
    (h = e[d]) && (n = (i ? h(t, a, n) : h(n)) || n);
  return i && n && x(t, a, n), n;
}, b = (e, t, a) => t.has(e) || U("Cannot " + a), o = (e, t, a) => (b(e, t, "read from private field"), t.get(e)), g = (e, t, a) => t.has(e) ? U("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), E = (e, t, a, i) => (b(e, t, "write to private field"), t.set(e, a), a), y = (e, t, a) => (b(e, t, "access private method"), a), r, w, m, f, v, k;
...
//# sourceMappingURL=godmode-utility-browser.element-DJXVsTFh.js.map
