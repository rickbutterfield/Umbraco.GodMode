...
import { LitElement as S, html as n, css as C, state as l, customElement as I } from "@umbraco-cms/backoffice/external/lit";
import { tryExecute as b } from "@umbraco-cms/backoffice/resources";
import { G as f, s as M } from "./index-D76lIRat.js";
import { DirectionModel as g } from "@umbraco-cms/backoffice/external/backend-api";
var D = Object.defineProperty, E = Object.getOwnPropertyDescriptor, v = (t) => {
  throw TypeError(t);
}, o = (t, e, s, h) => {
  for (var u = h > 1 ? void 0 : h ? E(e, s) : e, d = t.length - 1, m; d >= 0; d--)
    (m = t[d]) && (u = (h ? m(e, s, u) : m(u)) || u);
  return h && u && D(e, s, u), u;
}, A = (t, e, s) => e.has(t) || v("Cannot " + s), L = (t, e, s) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), r = (t, e, s) => (A(t, e, "access private method"), s), i, _, P, c, p, y, x, G, w;
let a = class extends $(S) {
  constructor() {
    super(), L(this, i), this._tableConfig = {
      allowSelection: !1,
      hideIcon: !0
    }, this._tableColumns = [
      {
...
_ = async function() {
  const { data: t } = await b(this, f.getUmbracoManagementApiV1GodModeGetMemberGroups());
...
P = function(t) {
  ...
  this.data = M(structuredClone(this.data), s, h ? g.DESCENDING : g.ASCENDING), this._tableItems = r(this, i, p).call(this, this.data);
};
c = async function() {
  this.isLoading = !0;
  const t = {
  ...
  const { data: e } = await b(this, f.getUmbracoManagementApiV1GodModeGetMembersPaged({ query: t }));
      ...
      data: [
        {
          ...
          value: n`<strong>${e.username || ""}</strong>`
        },
        {
          columnAlias: "name",
          value: e.name || ""
        ...
        {
          columnAlias: "email",
          value: n`<a href="mailto:${e.email}" target="_blank">${e.email || ""}</a>`
        },
        {
        ...
        {
          columnAlias: "id",
          value: n`<div><strong>${e.id || ""}</strong><br/><code style="font-size: 0.8em;">${e.udi || ""}</code></div>`
        }
      ]
    };
  });
...
//# sourceMappingURL=godmode-member-browser.element-DUQKErR8.js.map
